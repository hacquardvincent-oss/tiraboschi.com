...
| **Le tour de la pièce** (configurateur photographique) | `tiraboschi-tour-360.html` | `tools/demo/gabarit-tour.html` | `tests/tour/recette.js` |
...
modèle Cycles rendu avant l'arrivée des photographies. Le shooting du
08/09/2026 le rend caduc — voir ci-dessous.
